...
public class Application {
		...
		if (opcaoSelecionada != 4) {
			...
			do {
				opcaoSelecionada = Integer.parseInt(JOptionPane.showInputDialog(null,
						"Bem vindo ao Sistema de Gestão da Eleição." + "\n\nEscolha uma opção."
	...
	private static void configurarUrna() {
		...
		urnaEletronica.setMunicipio(JOptionPane.showInputDialog(null,
				"Configuração da Urna Eletrônica" + "\n\nDigite o nome do municipio"));
		urnaEletronica.setZonaEleitoral(
				Integer.parseInt(JOptionPane.showInputDialog(null, "Digite o número da Zona Eleitoral")));
		urnaEletronica.setSecaoEleitoral(
				Integer.parseInt(JOptionPane.showInputDialog(null, "Digite o número da Seção Eleitoral")));
	...
	private static void votar() {
		...
		if (configUrnaEletronica != null) {
			int numeroTitulo = Integer.parseInt(
					JOptionPane.showInputDialog(null, "Bem vindo à votação." + "\n\nInforme o Número do Título:"));

			if (verificarEleitorVotaAqui(numeroTitulo)) {

				System.out.println("Eleitor vota nessa Zona e Seção eleitoral");

				if (!verificarSeJaVotou(numeroTitulo,
						"dadosUrnas\\PresencaEleitores\\" + Integer.toString(configUrnaEletronica.getId()))) {
				...
				int opcaoSelecionada = Integer
						.parseInt(JOptionPane.showInputDialog(null, "Eleitor NÃO vota nessa Zona e Seção eleitoral"
			...
			int opcaoSelecionada = Integer.parseInt(JOptionPane.showInputDialog(null,
					"A urna não foi configurada." + "\n\nDeseja configurar a urna?" + "\n\n'1' SIM  -  '2' NÃO"));
			System.out.println("A urna não foi configurada.");
	...
	private static void realizarVoto(long numeroTitulo) {
		...
		do {
			numeroCandidato = Integer.parseInt(
					JOptionPane.showInputDialog(null, "Escolha do candidato." + "\n\nDigite o número do candidato"));
